...
class RegisterRequest(_message.Message):
    ...
    email: str
    type: str
    def __init__(self, login: _Optional[str] = ..., password: _Optional[str] = ..., 
                 email: _Optional[str] = ..., type: _Optional[str] = ...) -> None: ...
...
class UserReply(_message.Message):
    ...
    email: str
    type: str
    def __init__(self, id: _Optional[int] = ..., email: _Optional[str] = ..., 
